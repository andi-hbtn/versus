        ...
        <main className="bg-[#05020a] text-white overflow-hidden">
            ...
            <section className="font-maven relative min-h-[85vh] md:min-h-screen flex items-center justify-center px-6 py-20 md:py-0 text-center">
                ...
                <div className="relative max-w-4xl px-4 sm:px-6">
                    ...
                    {/* TRUST ROW */}
                    <div className=" mt-8 md:mt-10 flex flex-col md:flex-row items-center justify-center gap-2 md:gap-4 text-white/40 text-xs sm:text-sm">
                    ...
                    <div className="mt-8 md:mt-10">
                        <Link
                            ...
                            target="_blank"
                            className="inline-flex items-center justify-center gap-2 px-6 md:px-8 py-3 md:py-4 rounded-full bg-white text-black font-medium text-sm md:text-base hover:scale-105 active:scale-95 transition">
                            Schedule your call
